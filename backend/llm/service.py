...
class LLMService:
            ...
            if provider_config.get("enabled", False):
                try:
                    ...
                    if provider.validate_config():
                        ...
                        logger.warning(f"Invalid configuration for {provider_name} provider")
    ...
    async def analyze_requirements(
        ...
        try:
            ...
            return await self._try_fallback_providers("analyze_requirements", {
                "user_request": user_request,
    ...
    async def generate_iac(
        ...
        try:
            ...
            return await self._try_fallback_providers("generate_iac", {
    ...
    async def diagnose_error(
        ...
        try:
            ...
            return await self._try_fallback_providers("diagnose_error", {
                "error_logs": error_logs,
    ...
    async def _try_fallback_providers(self, method_name: str, kwargs: Dict[str, Any]) -> Dict[str, Any]:
